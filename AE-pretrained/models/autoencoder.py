"""
Convolutional Autoencoder implementation based on UNet architecture.
This module implements an autoencoder that reuses the UNet architecture
...
class ConvBlock(nn.Module):
    """
    Basic convolutional block for Autoencoder with spatial dropout.
...
class UpBlock(nn.Module):
    """
    Upsampling block for the decoder part of Autoencoder.
...
class Autoencoder(nn.Module):
    """
    Convolutional Autoencoder model based on UNet architecture for image reconstruction.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            out_channels: Number of output channels (3 for RGB images)
        ...
        # Create final reconstruction output layer
        self.reconstruction_output = nn.Sequential(
            nn.Conv2d(
                features_per_stage[0],  # First decoder stage features
                out_channels,           # Same number of output channels as input
                kernel_size=3,
                stride=1,
                padding=1,
                bias=True
    ...
    def forward(self, x):
        ...
        # Final layer to produce reconstructed image
        output = self.reconstruction_output(x)
        
        return output
    
    def get_encoder(self):
        """
        Get the encoder part of the autoencoder for transfer learning.
        
        Returns:
            nn.ModuleList: Encoder stages
        """
        return self.encoder_stages
    
    def get_decoder(self):
        """
        Get the decoder part of the autoencoder for transfer learning.
